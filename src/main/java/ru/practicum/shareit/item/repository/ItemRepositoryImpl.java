...
public class ItemRepositoryImpl implements ItemRepository {
    ...
    @Autowired
    public ItemRepositoryImpl(JdbcTemplate jdbcTemplate, UserRepository userStorage) {
    ...
    public List<Item> getItems(Long userId) {
        final String sqlQuery = "SELECT * FROM item WHERE OWNER = ?";
        return jdbcTemplate.query(sqlQuery, this::mapRow, userId);
    }

    @Override
    public Item getItem(Long itemId) {
        final String sqlQuery = "SELECT * FROM item WHERE id = ?";
    ...
    public Boolean isItemExists(Long id) {
        final String sqlQuery = "SELECT EXISTS(SELECT * FROM item WHERE id = ?)";
    ...
    public List<Item> searchItems(String text) {
        ...
        final String sqlQuery = "SELECT * FROM item " +
                "WHERE (LOWER(name) LIKE ? OR LOWER(description) LIKE ?) AND available = true";
